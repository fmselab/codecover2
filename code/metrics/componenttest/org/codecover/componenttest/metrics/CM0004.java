 ...
 * @version 1.0 ($Id: CM0004.java 71 2010-04-14 18:28:46Z schmidberger $)
 */
public class CM0004 extends junit.framework.TestCase {

    public void testCM0004() {
        String containerLocation = "../../qa/testdata/containers/metrics/metrics-statement.xml";
        ...
        for (HierarchyLevel curr : code.getChildren()) {
            ...
            if (curr.getName().equals("assignment")) {
                assertEquals(1, result.getCoveredItems());
            } else if (curr.getName().equals("whileLoop")) {
                assertEquals(1, result.getCoveredItems());
            } else {
