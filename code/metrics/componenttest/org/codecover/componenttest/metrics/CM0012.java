 ...
 * @version 1.0 ($Id: CM0012.java 71 2010-04-14 18:28:46Z schmidberger $)
 */
public class CM0012 extends junit.framework.TestCase {

    public void testCM0012() throws FileLoadException {
        String containerLocation = "../../qa/testdata/containers/metrics/metrics-loop-full.xml";
        ...
        assertEquals(3, result.getCoveredItems());
    }
