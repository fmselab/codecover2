 ...
 * @version 1.0 ($Id: CM0010.java 71 2010-04-14 18:28:46Z schmidberger $)
 */
public class CM0010 extends junit.framework.TestCase {

    public void testCM0010() throws FileLoadException {
        String containerLocation = "../../qa/testdata/containers/metrics/metrics-condition-first.xml";
        ...
        for (HierarchyLevel curr : code.getChildren()) {
            ...
            if (curr.getName().equals("complexIfAnd") || curr.getName().equals("complexIfOr")) {
