 ...
 * @version 1.0 ($Id: CobolLoopTest.java 1 2007-12-12 17:37:26Z t-scheller $)
 */
public class CobolLoopTest extends TestCase {
    ...
    public void testLoopCoverage() {
        String srcPath = SOURCE + "LoopCoverage/loopCoverage.cob";
        File source = new File(srcPath);
        String targetPath = TARGET + "LoopCoverage/loopCoverage.cob";
