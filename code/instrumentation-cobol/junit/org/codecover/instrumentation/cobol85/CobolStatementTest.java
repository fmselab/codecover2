 ...
 * @version 1.0 ($Id: CobolStatementTest.java 1 2007-12-12 17:37:26Z t-scheller $)
 *
 */
public class CobolStatementTest extends TestCase {
    ...
    public void testStatementCoverage() {
        String srcPath = SOURCE + "StatementCoverage/statementCoverage.cob";
        File source = new File(srcPath);
        String targetPath = TARGET + "StatementCoverage/statementCoverage.cob";
