 ...
 * @version 1.0 ($Id: CobolAllTest.java 1 2007-12-12 17:37:26Z t-scheller $)
 */
public class CobolAllTest extends TestCase {

    org.codecover.instrumentation.Instrumenter instrumenter;
    ...
    public void testAllCoverage() {
        String srcPath = SOURCE + "AllCoverage/allCoverage.cob";
        File source = new File(srcPath);
        String targetPath = TARGET + "AllCoverage/allCoverage.cob";
