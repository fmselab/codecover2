...
public class AllTests extends TestSuite {
    ...
    public static Test suite() {
        ...
        suite.addTestSuite(CobolConditionParserTest.class);
        ...
        suite.addTestSuite(CobolDataDivisionTest.class);
        suite.addTestSuite(CobolNonInstrumentationTest.class);
        suite.addTestSuite(CobolStatementTest.class);
        suite.addTestSuite(CobolBranchTest.class);
        suite.addTestSuite(CobolConditionTest.class);
        suite.addTestSuite(CobolCounterTest.class);
        suite.addTestSuite(CobolLoopTest.class);
        suite.addTestSuite(CobolNestedProgramTest.class);
        suite.addTestSuite(CobolAllTest.class);
        
        suite.addTestSuite(CounterProviderTest.class);
        suite.addTestSuite(NodeCounterTest.class);
