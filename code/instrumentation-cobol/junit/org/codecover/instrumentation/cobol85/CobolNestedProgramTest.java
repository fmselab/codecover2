 ...
 * @version 1.0 ($Id: CobolNestedProgramTest.java 1 2007-12-12 17:37:26Z t-scheller $)
 */
public class CobolNestedProgramTest extends TestCase {
    ...
    public void testNestedProgram() {
        String srcPath = SOURCE + "NestedProgram/nestedProgram.cob";
        File source = new File(srcPath);
        String targetPath = TARGET + "NestedProgram/nestedProgram.cob";
