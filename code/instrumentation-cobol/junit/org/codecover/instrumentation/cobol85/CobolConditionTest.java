 ...
 * @version 1.0 ($Id: CobolConditionTest.java 1 2007-12-12 17:37:26Z t-scheller $)
 */
public class CobolConditionTest extends TestCase {
    ...
    public void testConditionCoverage() {
        String srcPath = SOURCE + "ConditionCoverage/conditionCoverage.cob";
        File source = new File(srcPath);
        String targetPath = TARGET + "ConditionCoverage/conditionCoverage.cob";
