 ...
 * @version 1.0 ($Id: CobolNonInstrumentationTest.java 1 2007-12-12 17:37:26Z t-scheller $)
 */
public class CobolNonInstrumentationTest extends TestCase {
    ...
    public void testNonInstrumentationTest() {
        String srcPath = SOURCE + "AllCoverage/allCoverage.cob";
        File source = new File(srcPath);
        String targetPath = TARGET + "NonCoverage/allCoverage.cob";
