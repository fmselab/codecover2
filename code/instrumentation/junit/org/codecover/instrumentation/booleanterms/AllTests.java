...
public class AllTests extends TestSuite {
    ...
    public static Test suite() {
        ...
        suite.addTestSuite(InstrBooleanOperatorTest.class);
        suite.addTestSuite(InstrBasicBooleanTermTest.class);
        suite.addTestSuite(InstrBracketTermTest.class);
        // the InstrOperatorTerm is tested in the Projekt Instrumentation - java
