...
public class AllTests extends TestSuite {
    ...
    public static Test suite() {
        ...
        suite.addTestSuite(SmallOneConditionCounterTest.class);
        suite.addTestSuite(SmallTwoConditionCounterTest.class);
        suite.addTestSuite(MediumConditionCounterTest.class);
        suite.addTestSuite(LargeConditionCounterTest.class);
