...
public interface CharStream {
     ...
     * anything that they want to.<br>
     * In contrast to {@link #getSourceFileImage()} this image does not contain
     * any escaped Unicodes like <code>\u0020</code> but their parsed images:
     * <code>' '</code>.
     */
    public String getParsedImage();

    /**
     * Returns the unescaped characters from the marked token beginning to the
     * current buffer position.<br>
     * In contrast to {@link #getParsedImage()} this image has to contain the
     * escaped Unicodes like <code>\u0020</code>.
     */
