 ...
 * @version 1.0 ($Id: FileVersionSAXException.java 1 2007-12-12 17:37:26Z t-scheller $)
 */
public class FileVersionSAXException extends RuntimeException {
     ...
     */
    public FileVersionSAXException(String message, int major, int minor) {
        super(message);
        this.major = major;
        this.minor = minor;
    }
     ...
     *            the minor component of the version.
     */
    public FileVersionSAXException(String message, Throwable cause, int major,
            int minor) {
        super(message, cause);
        this.major = major;
        this.minor = minor;
