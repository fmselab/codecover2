///////////////////////////////////////////////////////////////////////////////
//
// $Id: SynchronizedConditionCounter.java 1 2007-12-12 17:37:26Z t-scheller $
// 
 ...
 */
public class SynchronizedConditionCounter implements CounterContainer {
    ...
    public SynchronizedConditionCounter(String varname) {
        this.varname = varname;
        this.counters = new HashMap<Integer, LongContainer>(17);
    }

    public synchronized boolean add(int booleanAssignments) {
