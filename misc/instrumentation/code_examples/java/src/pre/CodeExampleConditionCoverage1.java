...
///////////////////////////////////////////////////////////////////////////////
//
// $Id: CodeExampleConditionCoverage1.java 1 2007-12-12 17:37:26Z t-scheller $
// 
 ...
 * 
 */
public class CodeExampleConditionCoverage1 {
    ...
    public static void main(String[] args) {
        try {
            CodeExampleConditionCoverage1 cE = new CodeExampleConditionCoverage1();
            ...
            for (EApproxMode mode : approxModes) {
                ...
                Boolean term0001 = null;
                boolean result0001 = (term0001 = new Boolean(
                        mode.ordinal() >= approxModes.length - 1))
                        .booleanValue();
                if (term0001 == null) {
                    // wurde nicht ausgewertet
                } else if (term0001.booleanValue()) {
                    // war true
                } else {
                    // war false
                }
    ...
    public CodeExampleConditionCoverage1() throws Exception {
        this.left = 0.0;
        this.right = Math.PI;
