 ...
 * </PRE>
 */
public class ExecSQLStatementCommit implements Node {
   private Node parent;
   public NodeToken f0;
   public NodeToken f1;

   public ExecSQLStatementCommit(NodeToken n0, NodeToken n1) {
      f0 = n0;
   ...
   public ExecSQLStatementCommit() {
      f0 = new NodeToken("commit");
      if ( f0 != null ) f0.setParent(this);
      f1 = new NodeToken("work");
      if ( f1 != null ) f1.setParent(this);
   }
