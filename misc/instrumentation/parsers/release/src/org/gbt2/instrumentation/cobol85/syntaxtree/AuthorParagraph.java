///////////////////////////////////////////////////////////////////////////////
//
// $Id: AuthorParagraph.java 1 2007-12-12 17:37:26Z t-scheller $
// 
///////////////////////////////////////////////////////////////////////////////
 ...
 * </PRE>
 */
public class AuthorParagraph implements Node {
   private Node parent;
   public NodeToken f0;
   public NodeToken f1;
   public NodeOptional f2;

   public AuthorParagraph(NodeToken n0, NodeToken n1, NodeOptional n2) {
      f0 = n0;
   ...
   public AuthorParagraph(NodeToken n0, NodeOptional n1) {
      f0 = new NodeToken("author");
      if ( f0 != null ) f0.setParent(this);
      f1 = n0;
      if ( f1 != null ) f1.setParent(this);
      f2 = n1;
