///////////////////////////////////////////////////////////////////////////////
//
// $Id: MemberValueArrayInitializer.java 1 2007-12-12 17:37:26Z t-scheller $
// 
...
public class MemberValueArrayInitializer implements Node {
    ...
    public MemberValueArrayInitializer(NodeToken n0, MemberValue n1,
            NodeListOptional n2, NodeOptional n3, NodeToken n4) {
        f0 = n0;
        if (f0 != null)
            f0.setParent(this);
        f1 = n1;
    ...
    public MemberValueArrayInitializer(MemberValue n0, NodeListOptional n1,
            NodeOptional n2) {
        f0 = new NodeToken("{");
        if (f0 != null)
            f0.setParent(this);
