 ...
 */
public class ParseException extends org.gbt2.instrumentation.ParseException {
    ...
    /**
         ...
         * of this type with the fields "currentToken",
         * "expectedTokenSequences", and "tokenImage" set. The boolean flag
         * "specialConstructor" is also set to true to indicate that this
    ...
    /**
         ...
         * "currentToken" and "expectedTokenSequences" to generate a parse error
         * message and returns it. If this object has been created due to a
         * parse error, and you do not catch it (it gets thrown from the
         * parser), then this method is called during the printing of the final
