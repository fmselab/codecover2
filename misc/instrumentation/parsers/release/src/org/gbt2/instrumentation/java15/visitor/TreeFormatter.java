 ...
 */
public class TreeFormatter extends DepthFirstVisitorWithException {
    ...
    /**
         * The default constructor assumes an indentation amount of 3 spaces and
         * no line-wrap. You may alternately use the other constructor to
    ...
    /**
         ...
         */
    protected void processList(NodeListInterface n) throws IOException {
	processList(n, null);
    }

    protected void processList(NodeListInterface n, FormatCommand cmd) throws IOException {
    ...
    /**
         ...
         * given the current location information. The token will follow on the
         * next line, at the proper indentation level. If this is not the
    ...
    /**
         ...
         * information into the NodeToken. Takes into account line-wrap. Does
         * not update curLine and curColumn.
         */
