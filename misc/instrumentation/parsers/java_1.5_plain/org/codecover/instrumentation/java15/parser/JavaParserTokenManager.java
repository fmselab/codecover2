 ...
 *
 * @version 1.0 ($Id: JavaParserTokenManager.java 1 2007-12-12 17:37:26Z t-scheller $)
 */
...
protected Token jjFillToken()
{
   ...
   t.setImages(input_stream.getSourceFileImage(),
  ...
  {   
   ...
   for (;;)
   {
     ...
     try { input_stream.readChar(); input_stream.backup(1); }
        ...
        EOFSeen = true;
        error_after = curPos <= 1 ? "" : input_stream.getParsedImage();
        if (curChar == '\n' || curChar == '\r') {
           error_line++;
           error_column = 0;
        }
