 ...
 * about 6562 files, 65.906.383 Bytes<br>
 * 
 * @author Christoph Müller 
 *
 * @version 1.0 ($Id: JDK100WithJavaCharStream.java 1 2007-12-12 17:37:26Z t-scheller $)
 */
public class JDK100WithJavaCharStream {
    ...
    public static void main(String[] args) {
        try {
            ...
            PrintWriter writer = new PrintWriter(new BufferedWriter(new FileWriter("stuff/jdk100-JavaCharStream.log")));
            ...
            for (int i = 1; iterator.hasNext() && i <= 100; i++) {
                ...
                writer.printf("%5d %6d %10d %10d%n",
                        ...
                        new Long(ObjectSizer.getMemoryUse()));
                String content = FileTool.getContentFromFile(thisFile, Charset.defaultCharset());
                parse(content);
                writer.printf("%5d %6d %10d %10d%n",
                        new Integer(i),
                        new Long(timer.getDifference()),
