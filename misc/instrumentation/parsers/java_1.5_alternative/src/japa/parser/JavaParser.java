 ...
 * @author Júlio Vilmar Gesser - bug fixes and added AST generation
 */
 ...
 */
  ...
  final public EnumConstantDeclaration EnumConstant() throws ParseException {
    ...
    {if (true) return new EnumConstantDeclaration(line, column, name, args, classBody);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public ExplicitConstructorInvocationStmt ExplicitConstructorInvocation() throws ParseException {
    ...
    if (jj_2_9(2147483647)) {
      ...
      case LPAREN:
        ...
        jj_consume_token(SUPER);
                   if (expr!=null){line=expr.getLine(); column=expr.getColumn();} else {line=token.beginLine; column=token.beginColumn;}
        args = Arguments();
        jj_consume_token(SEMICOLON);
        break;
      default:
    ...
    {if (true) return new ExplicitConstructorInvocationStmt(line, column, isThis, expr, args);}
    throw new Error("Missing return statement in function");
  }
...
// this.
  ...
  final public Expression PrimaryPrefix() throws ParseException {
    ...
    case SUPER:
      ...
      jj_consume_token(DOT);
      jj_consume_token(IDENTIFIER);
                                                                                       ret = new SuperMemberAccessExpr(line, column, token.image);
      break;
    case LPAREN:
      jj_consume_token(LPAREN);
               line=token.beginLine; column=token.beginColumn;
  ...
  final public Expression PrimarySuffix(Expression scope) throws ParseException {
    ...
    case DOT:
      ...
      case LT:
        ...
        case LT:
          list = TypeArguments();
                                          line=((Type)list.get(0)).getLine(); column=((Type)list.get(0)).getColumn();
          break;
        default:
          jj_la1[83] = jj_gen;
          ;
        ...
        jj_consume_token(IDENTIFIER);
                              if(line==-1){line=token.beginLine; column=token.beginColumn;} ret = new FieldAccessExpr(line, column, scope, list, token.image);
        break;
      default:
        jj_la1[84] = jj_gen;
        jj_consume_token(-1);
    ...
    case LPAREN:
      list = Arguments();
                               ret = new MethodCallExpr(scope.getLine(), scope.getColumn(), scope, list);
      break;
    default:
      jj_la1[85] = jj_gen;
      jj_consume_token(-1);
  ...
  final public Expression Literal() throws ParseException {
    ...
    case INTEGER_LITERAL:
      jj_consume_token(INTEGER_LITERAL);
                try {
                        ret = LiteralExpr.newIntegerLiteral(token.beginLine, token.beginColumn, token.image);
    ...
    case LONG_LITERAL:
      jj_consume_token(LONG_LITERAL);
                try {
                        ret = LiteralExpr.newLongLiteral(token.beginLine, token.beginColumn, token.image);
                } catch (NumberFormatException e) {
    ...
    case FLOATING_POINT_LITERAL:
      jj_consume_token(FLOATING_POINT_LITERAL);
                try {
                        ret = new LiteralExpr(token.beginLine, token.beginColumn, Double.parseDouble(token.image));
                } catch (NumberFormatException e) {
    ...
    case CHARACTER_LITERAL:
      jj_consume_token(CHARACTER_LITERAL);
                try {
                        ret = LiteralExpr.newCharLiteral(token.beginLine, token.beginColumn, token.image);
                } catch (NumberFormatException e) {
    ...
    case STRING_LITERAL:
      jj_consume_token(STRING_LITERAL);
                              ret = new LiteralExpr(token.beginLine, token.beginColumn, token.image.substring(1, token.image.length()-1));
      break;
    case FALSE:
    case TRUE:
      ret = BooleanLiteral();
  ...
  final public Expression BooleanLiteral() throws ParseException {
    ...
    case TRUE:
      jj_consume_token(TRUE);
                   ret = new LiteralExpr(token.beginLine, token.beginColumn, Boolean.TRUE);
      break;
    case FALSE:
      jj_consume_token(FALSE);
                    ret = new LiteralExpr(token.beginLine, token.beginColumn, Boolean.FALSE);
      break;
    default:
      jj_la1[87] = jj_gen;
      jj_consume_token(-1);
  ...
  final public Expression NullLiteral() throws ParseException {
    ...
    {if (true) return new LiteralExpr(token.beginLine, token.beginColumn, null);}
    throw new Error("Missing return statement in function");
  }
